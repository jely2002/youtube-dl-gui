...
const defaultSettingsInstance = new Settings({settings: "tests/test-settings.json"}, env, false, true, "full", "49", 8, true, true, "C:\\Users\\user\\cookies.txt", false, true, false, false, true);
